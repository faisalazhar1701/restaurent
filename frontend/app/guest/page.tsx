...
function GuestEntryPageInner() {
  ...
  return (
    <main className="flex min-h-screen flex-1 flex-col bg-blue-800">
      <div className="flex flex-1 flex-col items-center justify-center px-6 py-16">
        ...
        <button
          ...
          className="mt-12 w-full max-w-xs rounded-xl bg-white px-6 py-4 text-base font-semibold text-gray-900 transition-opacity hover:opacity-90 disabled:opacity-50"
        >
    ...
    <main className="flex min-h-screen flex-1 flex-col bg-blue-800">
      <div className="flex flex-1 flex-col items-center justify-center px-6 py-16">
        ...
        <button
          type="button"
          disabled
          className="mt-12 w-full max-w-xs rounded-xl bg-white px-6 py-4 text-base font-semibold text-gray-900 transition-opacity disabled:opacity-50"
        >
          Start order
        </button>
      </div>
